...
namespace DockerWeb.ComHelper
{
    ...
    {
        //  private static  string Coonstr = "192.168.0.113:6379";
      //  private static string Coonstr = "localhost:6379";
        private static string Coonstr = "192.168.0.113:7001,password=123456";  //redis 集群
        ...
        /// </summary>
        /// <returns></returns>
        public static IDatabase GetDatabase(int num)
        {
            return Instance.GetDatabase(num);
        }
        ...
        {
            Coonstr = "192.168.0.113:7001,password=123456";
        }
        /// <summary>
        /// 更改集群
        /// </summary>
